        ...
        <script>
            ...
            jQuery(document).ready(function () {
                ...
                $('.summernote').summernote({
                    ...
                    focus: false,              // set focus to editable areafterinitializing summernote
                    fontNames: ['Open Sans', 'Arial', 'sans-serif'], // Use "Open Sans" as the desired font
                    fontNamesIgnoreCheck: ['Open Sans', 'Arial', 'sans-serif'],
                });
                // Select2
                $(".select2").select2();
