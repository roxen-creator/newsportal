...
// Define an array of category icons (replace 'icon-name' with actual icon names)
$categoryIcons = array(
  'Category1' => 'fa-icon-name1',
  'Category2' => 'fa-icon-name2',
      ...
      <div class="col-md-8">
        ...
        if ($rowcount == 0) {
          ...
          while ($row = mysqli_fetch_array($query)) {
            ?>
            <h1>
              <i class="fas <?php echo $categoryIcons[$row['category']]; ?>"></i>
              <?php echo htmlentities($row['category']); ?> News
            </h1>
            <div class="card mb-4">
